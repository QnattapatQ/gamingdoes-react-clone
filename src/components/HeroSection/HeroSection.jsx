...
const HeroSection = () => {
    return (
        <div className='relative'>
            <div className='block text-white h-full px-4 pt-[100px]'>
                <div className='max-w-[1332px] w-full mx-auto'>
                    <div className='grid grid-cols-[1fr_300px] gap-8 h-full max-2xl:grid-cols-[1fr_260px] max-2xl:gap-5 max-xl:grid-cols-[1fr_186px] max-xl:gap-3'>
