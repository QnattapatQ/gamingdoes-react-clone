...
import BackdropBG from '../BackdropBG/BackdropBG';

const HeroSection = () => {

    const [currentIndexOfSlide, setCurentIndexOfSlide] = useState(0);
    ...
    return (
        <div>
                    ...
                    <div className='max-w-[1332px] w-full mx-auto'>
                        <div className='grid grid-cols-[1fr_300px] gap-8 h-full max-2xl:grid-cols-[1fr_260px] max-2xl:gap-5 max-xl:grid-cols-[1fr_186px] max-xl:gap-3 max-lg:grid-cols-[1fr] max-lg:gap-0'>
                            <div className='h-full overflow-hidden'>
                                <SlideShow getIndex={setCurentIndexOfSlide}/>
                            </div>
            ...
            <BackdropBG currentIndex={currentIndexOfSlide}/>
        </div>
    ) 
}
